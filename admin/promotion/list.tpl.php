                  ...
                  <tbody>
                    ...
                    ?>
                      <tr class="promotion-row">
                        ...
                        <td>
                          <?php echo ($row_1 !== null) ? 'Đang khuyến mãi' : 'Đã khuyến mãi'; ?>
                        </td>
                        <td>
                        ...
                        <td id="a">
                          ...
                          <a href="promotion/detail.php?id_promotion=<?php echo $promotion['id_promotion']; ?>"><span class="material-symbols-outlined">steppers</span></a>
                        </td>
                      </tr>
                    <?php endwhile; ?>
                  </tbody>
