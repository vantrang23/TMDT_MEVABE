...
<body>
    ...
    <section class="product spad" id="product">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-7 cd    ">
                            ...
                            <div class="col-lg-4 col-md-5">
                                <div class="filter__sort">
                                    ...
                                    <select id="sort-box" onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);">
                                        <option <?php if (isset($_GET['sort']) && $_GET['sort'] == "desc") { ?> selected <?php } ?> value="shop-category.php?field=price&sort=desc&category_id=<?php echo $category_id ?>">Giá cao đến thấp</option>
                                        <option <?php if (isset($_GET['sort']) && $_GET['sort'] == "asc") { ?> selected <?php } ?> value="shop-category.php?field=price&sort=asc&category_id=<?php echo $category_id ?>">Giá thấp đến cao</option>
                                        <option <?php if (isset($_GET['field']) && $_GET['field'] == "created") { ?> selected <?php } ?> value="shop-category.php?field=created&sort=desc&category_id=<?php echo $category_id ?>">Sản phẩm mới nhất</option>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="row" id="ad">
                        <?php
                        $sql = "SELECT * FROM product where category_id='$category_id'" . $orderConditon . " ";
                                    ...
                                    <div class="product__item">
                                        ...
                                        <div class="product__item__text">
                                            ...
                                            if ($row_1 == null) {
                                                ...
                                                echo '<h5><a style="color:#E91E63; font-weight:500;" id="mar" href="shop-details.php?product_id=' . $row['product_id'] . '">' . number_format($discountedPrice, 0, '', '.') . ' VNĐ</a></h5>';
                                                echo '<h5><a id="giagoc"style="color:#E91E63; font-weight:500;" id="mar" href="shop-details.php?product_id=' . $row['product_id'] . '">' . number_format($price, 0, '', '.') . ' VNĐ</a></h5>';
                                            }
                                            ?>
                    ...
                    <div class="product__discount">
                        ...
                        <div class="row">
                            ...
                            $sql = "SELECT pro.*, prom.discount as prom_discount, cate.name as cate_name
                                                 ...
                                                 WHERE pro.id_promotion=prom.id_promotion and pro.category_id=cate.category_id and pro.id_promotion >0  AND (prom.end_day > CURDATE() OR prom.end_day = CURDATE()) and pro.category_id='$category_id' LIMIT 7";
                            $result = mysqli_query($conn, $sql);
                            if (mysqli_num_rows($result) > 0) {
